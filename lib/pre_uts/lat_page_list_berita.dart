...
class LatPageListBerita extends StatefulWidget {
  const LatPageListBerita({Key? key}) : super(key: key);

  @override
  State<LatPageListBerita> createState() => _LatPageListBeritaState();
}

class _LatPageListBeritaState extends State<LatPageListBerita> {
